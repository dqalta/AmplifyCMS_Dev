...
<html>
    <head>    
        ...
        <script src="/MasonryCMS/home/masonryAdmin/maintenance/texture/script.js" type="text/javascript"></script>        
    </head>
        ...
        <st:if test="%{sesionActiva == true}"> 
            ...
            <st:if test="%{permiso == true}">              
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="titulo">Textures<hr/></div>
                                ...
                                <div id="form-panel" class="panel-collapse collapse">
                                    <div class="panel-body">    
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#maintenanceTab" data-toggle="tab" aria-expanded="true">Maintenance-Textures</a></li>                  
                                        </ul>
                                        <div id="tabsContents" class="tab-content">
                                            <div class="tab-pane fade active in" id="maintenanceTab">    
                                                <div class="container-fluid">
                                                    <st:form id="formulario" name="formulario" cssClass="form-vertical" action="texture" method="post" theme="bootstrap">                                        
                        ...
                        <div style="padding: 20px;" class="table-responsive">
                            ...
                            <table id="table_texture" class="table table-striped" style="width:100%; margin: 0px auto;">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Description</th>
                                ...
                                <tbody>
                                    <st:if test="%{!getTextures().isEmpty()}">
                                        <st:iterator value="Textures" var="Textures" status="index">
                                            <tr>
                                                <td><st:property value="%{#Textures.id}" /></td>           
                                                <td><st:property value="%{#Textures.description}" /></td>        
                                                <td><st:date name="%{#Textures.created}" format="dd/MM/yyyy"/></td>       
                                                <td><st:property value="%{#Textures.createdBy}" /></td>    
                                                <td><st:date name="%{#Textures.modified}" format="dd/MM/yyyy"/></td>    
                                                <td><st:property value="%{#Textures.modifiedBy}" /></td>       
                                                <td>
                                                    <st:if test="%{#Textures.active == true}">
                                                ...
                                                <td onclick="edit('<st:property value="%{#Textures.id}" />');"><i class="glyphicon glyphicon-pencil" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Row"></i></td>
                                            </tr>
                                        </st:iterator>
                                    </st:if>
                                </tbody>
