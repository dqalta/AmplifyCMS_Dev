...
<html>
    <head>    
        ...
        <script src="/MasonryCMS/home/masonryAdmin/maintenance/material/script.js" type="text/javascript"></script>        
    </head>
    <body style="margin: 0px;">
        <st:if test="%{sesionActiva == true}"> 
            ...
            <st:include value="/generals/navBarHead.jsp" >
                <st:param name="title">MATERIALS</st:param>
            </st:include> 
            <st:if test="%{permiso == true}">              
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="titulo">Materials<hr/></div>
                                ...
                                <div id="form-panel" class="panel-collapse collapse">
                                    <div class="panel-body">    
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#maintenanceTab" data-toggle="tab" aria-expanded="true">Maintenance-Product Materials</a></li>                  
                                        </ul>
                                        <div id="tabsContents" class="tab-content">
                                            <div class="tab-pane fade active in" id="maintenanceTab">    
                                                <div class="container-fluid">
                                                    <st:form id="formulario" name="formulario" cssClass="form-vertical" action="material" method="post" theme="bootstrap">                                        
                        ...
                        <div style="padding: 20px;" class="table-responsive">
                            ...
                            <table id="table_materials" class="table table-striped" style="width:100%; margin: 0px auto;">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Description</th>
                                ...
                                <tbody>
                                    <st:if test="%{!getMaterials().isEmpty()}">
                                        <st:iterator value="Materials" var="Materials" status="index">
                                            <tr>
                                                <td><st:property value="%{#Materials.id}" /></td>           
                                                <td><st:property value="%{#Materials.description}" /></td>        
                                                <td><st:date name="%{#Materials.created}" format="dd/MM/yyyy"/></td>       
                                                <td><st:property value="%{#Materials.createdBy}" /></td>    
                                                <td><st:date name="%{#Materials.modified}" format="dd/MM/yyyy"/></td>    
                                                <td><st:property value="%{#Materials.modifiedBy}" /></td>       
                                                <td>
                                                    <st:if test="%{#Materials.active == true}">
                                                ...
                                                <td onclick="edit('<st:property value="%{#Materials.id}" />');"><i class="glyphicon glyphicon-pencil" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Row"></i></td>
                                            </tr>
                                        </st:iterator>
                                    </st:if>
                                </tbody>
