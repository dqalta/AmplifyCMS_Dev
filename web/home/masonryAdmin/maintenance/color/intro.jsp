...
<html>
    <head>    
        ...
        <script src="/MasonryCMS/home/masonryAdmin/maintenance/color/script.js" type="text/javascript"></script>        
    </head>
    <body style="margin: 0px;">
        <st:if test="%{sesionActiva == true}"> 
            ...
            <st:include value="/generals/navBarHead.jsp" >
                <st:param name="title">COLORS</st:param>
            </st:include> 
                ...
                <div class="container-fluid">
                    <div class="row">
                                ...
                                <div id="form-panel" class="panel-collapse collapse">
                                    <div class="panel-body">    
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#maintenanceTab" data-toggle="tab" aria-expanded="true">Maintenance-Colors</a></li>                  
                                        </ul>
                                        <div id="tabsContents" class="tab-content">
                                            <div class="tab-pane fade active in" id="maintenanceTab">    
                                                <div class="container-fluid">
                                                    <st:form id="formulario" name="formulario" cssClass="form-vertical" action="color" method="post" theme="bootstrap">                                        
                        ...
                        <div style="padding: 20px;" class="table-responsive">
                            ...
                            <table id="table_color" class="table table-striped" style="width:100%; margin: 0px auto;">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Description</th>
                                ...
                                <tbody>
                                    <st:if test="%{!getColors().isEmpty()}">
                                        <st:iterator value="Colors" var="Colors" status="index">
                                            <tr>
                                                <td><st:property value="%{#Colors.id}" /></td>           
                                                <td><st:property value="%{#Colors.description}" /></td>        
                                                <td><st:date name="%{#Colors.created}" format="dd/MM/yyyy"/></td>       
                                                <td><st:property value="%{#Colors.createdBy}" /></td>    
                                                <td><st:date name="%{#Colors.modified}" format="dd/MM/yyyy"/></td>    
                                                <td><st:property value="%{#Colors.modifiedBy}" /></td>       
                                                <td>
                                                    <st:if test="%{#Colors.active == true}">
                                                ...
                                                <td onclick="edit('<st:property value="%{#Colors.id}" />');"><i class="glyphicon glyphicon-pencil" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Row"></i></td>
                                            </tr>
                                        </st:iterator>
                                    </st:if>
                                </tbody>
