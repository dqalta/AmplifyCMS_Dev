...
<html>
    <head>    
        ...
        <script src="/MasonryCMS/home/masonryAdmin/maintenance/metricsSystem/script.js" type="text/javascript"></script>        
    </head>
                ...
                <div class="container-fluid">
                    <div class="row">
                                ...
                                <div id="form-panel" class="panel-collapse collapse">
                                    <div class="panel-body">    
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#maintenanceTab" data-toggle="tab" aria-expanded="true"> Maintenance-Units </a></li>                  
                                        </ul>
                                        <div id="tabsContents" class="tab-content">
                                            <div class="tab-pane fade active in" id="maintenanceTab">    
                                                <div class="container-fluid">
                                                    <st:form id="formulario" name="formulario" cssClass="form-vertical" action="metricsSystem" method="post" theme="bootstrap">                                        
                        ...
                        <div style="padding: 20px;" class="table-responsive">
                            ...
                            <table id="table_metricsSystem" class="table table-striped" style="width:100%; margin: 0px auto;">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Description</th>
                                    ...
                                    <st:if test="%{!getMetricsSystems().isEmpty()}">
                                        <st:iterator value="MetricsSystems" var="MetricsSystems" status="index">
                                            <tr>
                                                ...
                                                <td><st:date name="%{#MetricsSystems.modified}" format="dd/MM/yyyy"/></td>    
                                                <td><st:property value="%{#MetricsSystems.modifiedBy}" /></td>       
                                                <td>
                                                    <st:if test="%{#MetricsSystems.active == true}">
                                                ...
                                                <td onclick="edit('<st:property value="%{#MetricsSystems.id}" />');"><i class="glyphicon glyphicon-pencil" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Row"></i></td>
                                            </tr>
                                        </st:iterator>
                                    </st:if>
                                </tbody>
