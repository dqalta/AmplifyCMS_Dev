...
<html>
    <head>    
        ...
        <script src="/MasonryCMS/home/masonryAdmin/maintenance/size/script.js" type="text/javascript"></script>        
    </head>
                ...
                <div class="container-fluid">
                    <div class="row">
                                ...
                                <div id="form-panel" class="panel-collapse collapse">
                                    <div class="panel-body">    
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#maintenanceTab" data-toggle="tab" aria-expanded="true">Maintenance-Sizes</a></li>                  
                                        </ul>
                                        <div id="tabsContents" class="tab-content">
                                            <div class="tab-pane fade active in" id="maintenanceTab">    
                                                <div class="container-fluid">
                                                    <st:form id="formulario" name="formulario" cssClass="form-vertical" action="size" method="post" theme="bootstrap">                                        
                        ...
                        <div style="padding: 20px;" class="table-responsive">
                            ...
                            <table id="table_size" class="table table-striped" style="width:100%; margin: 0px auto;">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>ID Metrics System</th>
                                        <th>Description</th>
                                        <th>Length</th>
                                        <th>Depth</th>
                                        <th>Widht</th>
                                ...
                                <tbody>
                                    <st:if test="%{!getSizes().isEmpty()}">
                                        <st:iterator value="Sizes" var="Sizes" status="index">
                                            <tr>
                                                <td><st:property value="%{#Sizes.id}" /></td>  
                                                <td><st:property value="%{#Sizes.idProductMaterial}" /></td>           
                                                ...
                                                <td><st:property value="%{#Sizes.modifiedBy}" /></td>       
                                                <td>
                                                    <st:if test="%{#Sizes.active == true}">
                                                ...
                                                <td onclick="edit('<st:property value="%{#Sizes.id}" />');"><i class="glyphicon glyphicon-pencil" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Row"></i></td>
                                            </tr>
                                        </st:iterator>
                                    </st:if>
                                </tbody>
