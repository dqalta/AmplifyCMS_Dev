...
<html>
    <head>    
        ...
        <script src="/MasonryCMS/home/masonryAdmin/maintenance/subMaterial/script.js" type="text/javascript"></script>        
    </head>
    <body style="margin: 0px;">
        <st:if test="%{sesionActiva == true}"> 
            ...
            <st:include value="/generals/navBarHead.jsp" >
                    <st:param name="title">SUBMATERIALS</st:param>
                </st:include>
            <st:if test="%{permiso == true}">              
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="titulo">Sub Material<hr/></div>
                                ...
                                <div id="form-panel" class="panel-collapse collapse">
                                    <div class="panel-body">    
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#maintenanceTab" data-toggle="tab" aria-expanded="true">Maintenance-Product SubMaterials</a></li>                  
                                        </ul>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">                                                      
                                                                <div class="form-group">
                                                                    <label for="idProductMaterial">Material:</label>
                                                                    <st:select class="form-control"  id="idProductMaterial" name="idProductMaterial" value="%{idProductMaterial}" list="materials" listKey="id" listValue="description"/>                                          
                                                                </div>
                                                            </div>  
                                                            <div class="col-sm-2">
                                                                <div class="form-group">
                        ...
                        <div style="padding: 20px;" class="table-responsive">
                            ...
                            <table id="table_subMaterial" class="table table-striped" style="width:100%; margin: 0px auto;">
                                ...
                                <tbody>
                                    <st:if test="%{!getSubMaterials().isEmpty()}">
                                        <st:iterator value="SubMaterials" var="SubMaterials" status="index">
                                            <tr>
                                                <td><st:property value="%{#SubMaterials.id}" /></td>  
                                                <td><st:property value="%{#SubMaterials.idProductMaterial}" /></td>           
                                                <td><st:property value="%{#SubMaterials.description}" /></td>        
                                                <td><st:date name="%{#SubMaterials.created}" format="dd/MM/yyyy"/></td>       
                                                <td><st:property value="%{#SubMaterials.createdBy}" /></td>    
                                                <td><st:date name="%{#SubMaterials.modified}" format="dd/MM/yyyy"/></td>    
                                                <td><st:property value="%{#SubMaterials.modifiedBy}" /></td>       
                                                <td>
                                                    <st:if test="%{#SubMaterials.active == true}">
                                                ...
                                                <td onclick="edit('<st:property value="%{#SubMaterials.id}" />');"><i class="glyphicon glyphicon-pencil" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Row"></i></td>
                                            </tr>
                                        </st:iterator>
                                    </st:if>
                                </tbody>
