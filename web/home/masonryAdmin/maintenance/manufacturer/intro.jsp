...
<html>
    <head>    
        ...
        <script src="/MasonryCMS/home/masonryAdmin/maintenance/manufacturer/script.js" type="text/javascript"></script>        
    </head>
    <body style="margin: 0px;">
        <st:if test="%{sesionActiva == true}">        
            <div class="titulo">MANUFACTURERS<hr/></div>
                ...
                <st:include value="/generals/navBarHead.jsp" >
                    <st:param name="title">MANUFACTURERS</st:param>
                </st:include>
                                ...
                                <div id="tabsContents" class="tab-content">
                                    <div class="tab-pane fade active in" id="maintenanceTab">    
                                        <div class="container-fluid">
                                            <st:form id="formulario" name="formulario" cssClass="form-vertical" action="manufacturer" method="post" theme="bootstrap">                                        
                ...
                <div style="padding: 20px;" class="table-responsive">
                    <table id="table_manufacturer" class="table table-striped" style="width:100%; margin: 0px auto;">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Description</th>
