...
<html>
    <head>    
        ...
        <script src="/MasonryCMS/home/masonryAdmin/maintenance/style/script.js" type="text/javascript"></script>        
    </head>
    <body style="margin: 0px;">
        <st:if test="%{sesionActiva == true}"> 
            ...
            <st:include value="/generals/navBarHead.jsp" >
                <st:param name="title">STYLES</st:param>
            </st:include>
                ...
                <div class="container-fluid">
                    <div class="row">
                                ...
                                <div id="form-panel" class="panel-collapse collapse">
                                    <div class="panel-body">    
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#maintenanceTab" data-toggle="tab" aria-expanded="true">Maintenance-Styles</a></li>                  
                                        </ul>
                                        <div id="tabsContents" class="tab-content">
                                            <div class="tab-pane fade active in" id="maintenanceTab">    
                                                <div class="container-fluid">
                                                    <st:form id="formulario" name="formulario" cssClass="form-vertical" action="style" method="post" theme="bootstrap">                                        
                        ...
                        <div style="padding: 20px;" class="table-responsive">
                            ...
                            <table id="table_style" class="table table-striped" style="width:100%; margin: 0px auto;">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Description</th>
                                ...
                                <tbody>
                                    <st:if test="%{!getStyles().isEmpty()}">
                                        <st:iterator value="Styles" var="Styles" status="index">
                                            <tr>
                                                <td><st:property value="%{#Styles.id}" /></td>           
                                                <td><st:property value="%{#Styles.description}" /></td>        
                                                <td><st:date name="%{#Styles.created}" format="dd/MM/yyyy"/></td>       
                                                <td><st:property value="%{#Styles.createdBy}" /></td>    
                                                <td><st:date name="%{#Styles.modified}" format="dd/MM/yyyy"/></td>    
                                                <td><st:property value="%{#Styles.modifiedBy}" /></td>       
                                                <td>
                                                    <st:if test="%{#Styles.active == true}">
                                                ...
                                                <td onclick="edit('<st:property value="%{#Styles.id}" />');"><i class="glyphicon glyphicon-pencil" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Row"></i></td>
                                            </tr>
                                        </st:iterator>
                                    </st:if>
                                </tbody>
