...
<html>
    <head>    
        ...
        <script src="/MasonryCMS/home/masonryAdmin/maintenance/collection/script.js" type="text/javascript"></script>        
    </head>
    <body style="margin: 0px;">
        <st:if test="%{sesionActiva == true}">        
            <div class="titulo">COLLECTIONS<hr/></div>
                        ...
                        <div id="form-panel" class="panel-collapse collapse">
                            <div class="panel-body">    
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#maintenanceTab" data-toggle="tab" aria-expanded="true">Maintenance-Collections</a></li>                  
                                </ul>
                                <div id="tabsContents" class="tab-content">
                                    <div class="tab-pane fade active in" id="maintenanceTab">    
                                        <div class="container-fluid">
                                            <st:form id="formulario" name="formulario" cssClass="form-vertical" action="collection" method="post" theme="bootstrap">                                        
                ...
                <div style="padding: 20px;" class="table-responsive">
                    <table id="table_collection" class="table table-striped" style="width:100%; margin: 0px auto;">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Description</th>
                            ...
                            <st:if test="%{!getCollections().isEmpty()}">
                                <st:iterator value="collections" var="collections" status="index">
                                    <tr>
                                        ...
                                        <td><st:date name="%{#collections.modified}" format="dd/MM/yyyy"/></td>    
                                        <td><st:property value="%{#collections.modifiedBy}" /></td>       
                                        <td>
                                            <st:if test="%{#collections.active == true}">
                                        ...
                                        <td onclick="edit('<st:property value="%{#collections.id}" />');"><i class="glyphicon glyphicon-pencil" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit Row"></i></td>
                                    </tr>
                                </st:iterator>
                            </st:if>
                        </tbody>
