 ...
 * @author CR104978
 */
public class Color extends ActionSupport implements SessionAware {
    ...
    //SET GET CUSTOMIZED
    public ArrayList<DtoColor> getColors() {
        return colors;
    }

    public void setColors(ArrayList<DtoColor> colors) {
        this.colors = colors;
    }
    ...
    public void chargeColors() {
        colors = MaintenanceSQL.getColors(mdk);
    }
    ...
    public void insert() {
        if (validateFields()) {//Valido los campos del formulario
            ...
            try {
                ...
                MaintenanceSQL.saveColors(mdk, m);
    ...
    public void update() {
        if (validateFields()) {
            ...
            try {
                ...
                DtoColor m = MaintenanceSQL.getColors(mdk, idEdit);
                if (m != null) {
                    ...
                    MaintenanceSQL.updateColors(mdk, m);
                    // AdmConsultas.bitacora(o2c, usuario, "Encargado modificado Tipo: " + tipo + ", Codigo: " + codigo);

                    tn.commit();
                    clearFields();
                    mensajes = mensajes + "info<>Information<>Color modified successfully.";
                    mensaje = true;
                } else {
                    insert();
                }
    ...
    public void readForUpdate() {
        ...
        if (m != null) {
            ...
            mensajes = mensajes + "danger<>Error<>Color does not exist.";
            mensaje = true;
        }
    }
