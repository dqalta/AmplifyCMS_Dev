 ...
 * @author CR104978
 */
public class Material extends ActionSupport implements SessionAware {
    ...
    private ArrayList<DtoMaterial> materials = new ArrayList<>();//Variable con la lista de datos
    ...
    //SET GET CUSToMIZED
    public ArrayList<DtoMaterial> getMaterials() {
        return materials;
    }

    public void setMaterials(ArrayList<DtoMaterial> materials) {
    ...
    public void chargeMaterials() {
        materials = MaintenanceSQL.getMaterials(mdk);
    }
    ...
    public void insert() {
        if (validateFields()) {//Valido los campos del formulario
            ...
            try {
                ...
                DtoMaterial m = new DtoMaterial();//Creo un objeto del tipo color
                ...
                MaintenanceSQL.saveMaterial(mdk, m);
                ...
                clearFields();
                mensajes = mensajes + "info<>Information<>Color saved successfully.";
                mensaje = true;
    ...
    public void update() {
        if (validateFields()) {
            ...
            try {
                ...
                DtoMaterial m = MaintenanceSQL.getMaterial(mdk, idEdit);
                if (m != null) {
                    ...
                    MaintenanceSQL.updateMaterial(mdk, m);
                    // AdmConsultas.bitacora(o2c, usuario, "Encargado modificado Tipo: " + tipo + ", Codigo: " + codigo);

                    tn.commit();
                    clearFields();
                    mensajes = mensajes + "info<>Information<>Material modified successfully.";
                    mensaje = true;
                } else {
                    insert();
                }
    ...
    public void readForUpdate() {
        ...
        if (m != null) {
            ...
            mensajes = mensajes + "danger<>Error<>Material does not exist.";
            mensaje = true;
        }
    }
