 ...
 * @author CR104978
 */
public class Style extends ActionSupport implements SessionAware {
    ...
    private ArrayList<DtoStyle> styles = new ArrayList<>();//Variable con la lista de datos
    ...
    //SET GET CUSToMIZED
    public ArrayList<DtoStyle> getStyles() {
        return styles;
    }

    public void setPackageTypes(ArrayList<DtoStyle> styles) {
        this.styles = styles;
    }
    ...
    public void chargeStyles() {
        styles = MaintenanceSQL.getStyles(mdk);
    }
    ...
    public void insert() {
        if (validateFields()) {//Valido los campos del formulario
            ...
            try {
                ...
                DtoStyle m = new DtoStyle();//Creo un objeto del tipo style
                ...
                MaintenanceSQL.saveStyles(mdk, m);
    ...
    public void update() {
        if (validateFields()) {
            ...
            try {
                ...
                DtoStyle m = MaintenanceSQL.getStyles(mdk, idEdit);
                if (m != null) {
                    ...
                    MaintenanceSQL.updateStyles(mdk, m);
