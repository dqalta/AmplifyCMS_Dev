 ...
 * @author CR104978
 */
public class PackageType extends ActionSupport implements SessionAware {
    ...
    //SET GET CUSToMIZED
    public ArrayList<DtoPackageType> getPackageTypes() {
        return packageTypes;
    }

    public void setPackageTypes(ArrayList<DtoPackageType> PackageTypes) {
    ...
    public void chargePackageTypes() {
        packageTypes = MaintenanceSQL.getPackageTypes(mdk);
    }
    ...
    public void insert() {
        if (validateFields()) {//Valido los campos del formulario
            ...
            try {
                ...
                DtoPackageType m = new DtoPackageType();//Creo un objeto del tipo PackageType
                ...
                MaintenanceSQL.savePackageType(mdk, m);
                ...
                clearFields();
                mensajes = mensajes + "info<>Information<>PackageType saved successfully.";
                mensaje = true;
    ...
    public void update() {
        if (validateFields()) {
            ...
            try {
                ...
                DtoPackageType m = MaintenanceSQL.getPackageType(mdk, idEdit);
                if (m != null) {
                    ...
                    MaintenanceSQL.updatePackageType(mdk, m);
                    // AdmConsultas.bitacora(o2c, usuario, "Encargado modificado Tipo: " + tipo + ", Codigo: " + codigo);

                    tn.commit();
                    clearFields();
                    mensajes = mensajes + "info<>Information<>Package type modified successfully.";
                    mensaje = true;
                } else {
                    insert();
                }
    ...
    public void readForUpdate() {
        ...
        if (m != null) {
            ...
            mensajes = mensajes + "danger<>Error<>PackageTypee does not exist.";
            mensaje = true;
        }
    }
