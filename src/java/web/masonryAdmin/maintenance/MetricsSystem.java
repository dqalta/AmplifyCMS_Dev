 ...
 * @author CR104978
 */
public class MetricsSystem extends ActionSupport implements SessionAware {
    ...
    public void insert() {
        if (validateFields()) {//Valido los campos del formulario
            ...
            try {
                ...
                clearFields();
                mensajes = mensajes + "info<>Information<>Measure System Saved saved successfully.";
                mensaje = true;
