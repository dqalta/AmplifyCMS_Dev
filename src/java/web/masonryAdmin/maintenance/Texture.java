 ...
 * @author CR104978
 */
public class Texture extends ActionSupport implements SessionAware {
    ...
    private ArrayList<DtoTexture> textures = new ArrayList<>();//Variable con la lista de datos
    ...
    //SET GET CUSToMIZED
    public ArrayList<DtoTexture> getTextures() {
        return textures;
    }

    public void setTextures(ArrayList<DtoTexture> Textures) {
    ...
    public void chargeTextures() {
        textures = MaintenanceSQL.getTextures(mdk);
    }
    ...
    public void insert() {
        if (validateFields()) {//Valido los campos del formulario
            ...
            try {
                ...
                DtoTexture m = new DtoTexture();//Creo un objeto del tipo style
                ...
                MaintenanceSQL.saveTextures(mdk, m);
                ...
                clearFields();
                mensajes = mensajes + "info<>Information<>Texture saved successfully.";
                mensaje = true;
    ...
    public void update() {
        if (validateFields()) {
            ...
            try {
                ...
                DtoTexture m = MaintenanceSQL.getTextures(mdk, idEdit);
                if (m != null) {
                    ...
                    MaintenanceSQL.updateTextures(mdk, m);
                    // AdmConsultas.bitacora(o2c, usuario, "Encargado modificado Tipo: " + tipo + ", Codigo: " + codigo);

                    tn.commit();
                    clearFields();
                    mensajes = mensajes + "info<>Information<>Style modified successfully.";
                    mensaje = true;
                } else {
                    insert();
                }
    ...
    public void readForUpdate() {
        ...
        if (m != null) {
            ...
            mensajes = mensajes + "danger<>Error<>Texture does not exist.";
            mensaje = true;
        }
    }
